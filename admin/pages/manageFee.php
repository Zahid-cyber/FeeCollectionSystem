									...
									?>
											<td class="center">
												<form action="editFee.php" method='post' class='action'>
													<button class="btn btn-info" type='submit' name='editFeeId' value="<?php echo $row['id'];?>" title='edit'>
												...
												?>
													<form action="" method='post' class='action'>
														<button onclick="return confirm('Are you want to delete it!')" class="btn btn-danger" type='submit' name='deleteFeeid' value="<?php echo $row['id'];?>"  title='delete'>
